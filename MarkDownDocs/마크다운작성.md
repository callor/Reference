...
```md
markdown- [x] this is a complete item
...
- [ ] this is an incomplete itemCopy

```md
markdown- [x] @mentions, #refs, [links](), **formatting**, and <del>tags</del> supported
```
